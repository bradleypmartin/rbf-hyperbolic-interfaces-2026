...
- 2026-09-17: `slides/figures/*.png` (2.5 MB) and `slides/talk.pdf` are
  committed so the deck builds and reads from a fresh clone; the MP4 clips
  stay in gitignored `outputs/` and are regenerated by the drivers.
