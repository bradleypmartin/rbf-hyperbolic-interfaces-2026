...
| 10–16 | Ch. 1 Introduction (history of interface treatments; RBF-FD overview §1.3 at p. 14) | Background: interface treatments before RBF-FD |
...
| 75–89 | Ch. 4 Heat problems in 1-D | Not needed here |
| 90–122 | Ch. 5 Heat problems in 2-D | Not needed here |
| 123–124 | Ch. 6 Conclusions | Summary |
...
| PDF pages | Section | Use for |
| --- | --- | --- |
| 2–3 | Abstract, introduction (dispersive vs interface errors; FD is first order across interfaces) | Framing |
...
| PDF pages | Section | Use for |
| --- | --- | --- |
| 2–4 | Abstract, introduction (advantages list; what changed vs the 2015 method) | Framing |
